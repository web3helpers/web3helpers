...
const AppCard = ({ app }: AppCardProps) => {
  ...
  const basicClassName =
    "card p-4 relative bg-transparent rounded-md border-2 text-bold text-xl text-black first-letter:text-2xl border-black dark:border-white border-2 hover:bg-[${app.chain.color}] before:content-[''] before:absolute before:border-2 before:rounded-md before:border-black before:box-content before:w-full before:h-full before:left-1 before:bottom-1";
  return (
    <>
      <Link href={app.path}>
